            ...
            <div className="p-6">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900">New lead captured from Campaign "Summer 2024"</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900">Lead converted: John Smith</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900">Campaign "Spring Outreach" paused</p>
